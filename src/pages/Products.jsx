                ...
                >
                  ...
                  <div style={{
                    ...
                    {p.imageUrl && p.imageUrl !== 'string' ? (
                      <img
                        src={`https://localhost:7126${p.imageUrl}`}
                        alt={p.name}
                  ...
                  <div style={{ padding: '16px' }}>
                    <h3 style={{ color: 'white', fontWeight: '600', fontSize: '15px', marginBottom: '4px' }}>
                      {p.name}
                    </h3>
                    <p style={{ color: '#6b7280', fontSize: '12px', marginBottom: '8px' }}>
                      {p.brand} • {p.origin}
                    </p>
                    <p style={{ color: '#9ca3af', fontSize: '11px', marginBottom: '12px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
                      <div>
                        ...
                        <p style={{ color: '#9ca3af', fontSize: '13px' }}>₹{p.costPrice}</p>
                      </div>
                ...
                <tbody>
                  {products.map((p, i) => (
                    ...
                    >
                      ...
                      <td style={{ padding: '14px 16px', color: '#9ca3af', fontSize: '13px' }}>{p.categoryName}</td>
                      <td style={{ padding: '14px 16px', color: '#9ca3af', fontSize: '13px' }}>{p.volume}ml</td>
                      <td style={{ padding: '14px 16px', color: '#9ca3af', fontSize: '13px' }}>{p.alcoholPercent}%</td>
                      <td style={{ padding: '14px 16px', color: '#9ca3af', fontSize: '13px' }}>₹{p.costPrice}</td>
                      <td style={{ padding: '14px 16px', color: '#4ade80', fontWeight: '600', fontSize: '14px' }}>₹{p.salePrice}</td>
                      <td style={{ padding: '14px 16px' }}>
                        <span style={{
                          padding: '3px 10px',
                          borderRadius: '20px',
                      ...
                      <td style={{ padding: '14px 16px' }}>
                        <div style={{ display: 'flex', gap: '6px' }}>
                          <button onClick={() => handleEdit(p)}
                            style={{ background: 'rgba(59,130,246,0.2)', border: 'none', borderRadius: '6px', padding: '4px 8px', color: '#60a5fa', cursor: 'pointer', fontSize: '13px' }}>
                            ✏️
                          </button>
                          <button onClick={() => handleToggle(p.id)}
                            style={{ background: 'rgba(245,158,11,0.2)', border: 'none', borderRadius: '6px', padding: '4px 8px', color: '#fbbf24', cursor: 'pointer', fontSize: '13px' }}>
                            🔄
                          </button>
                          <button onClick={() => handleDelete(p.id)}
                            style={{ background: 'rgba(239,68,68,0.2)', border: 'none', borderRadius: '6px', padding: '4px 8px', color: '#f87171', cursor: 'pointer', fontSize: '13px' }}>
                            🗑️
                          </button>
                        </div>
                      </td>
